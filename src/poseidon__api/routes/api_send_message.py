...
from src.conf.poseidon_input_worker import WORKER_NAME
from src.poseidon__db.helpers.get_json_schema_by_id import get_json_schema
from src.poseidon__uni_worker.lib import uni
...
def nfk_mk_message_email(api_resource: ApiResource, body: ApiSendMessageQueryModel, template_id: UUID) -> TJsonResponse:
    ...
    message = PoseidonInputV0Message(
